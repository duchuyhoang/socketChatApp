...
const ChatVideo = () => {
  ...
  useEffect(()=>{
    window.onload = function() {
      ...
      xhr.open("PUT", "https://global.xirsys.net/_turn/duchuyhoang.github.io", true);
      xhr.setRequestHeader ("Authorization", "Basic " + btoa("huyhoang:41988f64-3b31-11ec-8906-0242ac130002") );
...
// console.log(iceServer.iceServers);
      const newPeer = new Peer({key:"peerjs",host:PEERJS_SERVER,secure:true,port:443,config:

      {
        iceServers:[{
          username: "Bebl4LMhW9gs7INGS4VxdYtc6nCT6-VBAHXQRpOSekXCI2k9WuA76Oai2HAr5ekyAAAAAGGBXjFodXlob2FuZw==",
      ...
      const newStreamPeer = new Peer({key:"peerjs",host:PEERJS_SERVER,secure:true,port:443,config:
      {
        username: "Bebl4LMhW9gs7INGS4VxdYtc6nCT6-VBAHXQRpOSekXCI2k9WuA76Oai2HAr5ekyAAAAAGGBXjFodXlob2FuZw==",
       credential: "8e819244-3bf4-11ec-86f5-0242ac120004",   
       urls: [
